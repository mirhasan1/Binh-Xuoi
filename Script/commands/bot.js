...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Hasan") || (event.body.toLowerCase() == "eun") || (event.body.toLowerCase() == "Cha Eun Woo") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Ullash ッ ", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Eun Woo ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস  আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Eun WOo ッ❤️ তাকে সবাই চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "jan") || (event.body.toLowerCase() == "🥺")) {
     return api.sendMessage("️ এমনে ডাকলে প্রেমে পড়ে যাবো😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("সব  ধান্দা 😪🥱", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Bot Tomr name Ki") || (event.body.toLowerCase() == "khaicho")) {
     return api.sendMessage("Binh Xuoi <😘", threadID);
   };
